...
static const juce::Colour WAVEFORM_COLOR(juce::uint8(177), juce::uint8(55), juce::uint8(217), 1.0f);
static const juce::Colour WAVEFORM_BG_COLOR(juce::uint8(28), juce::uint8(28), juce::uint8(28), 1.0f);
